...
<form method="post" action="<?= $this->url->href('UserSettingsController', 'save', array('plugin' => 'OpteiaSkin', 'user_id' => $user['id'])) ?>">
    <?= $this->form->csrf() ?>
    <fieldset>
...
<?php if ($this->user->isAdmin()): ?>
    ...
    <fieldset>
        ...
        <?= $this->url->link(t('Opteia Skin Settings'), 'PluginConfigsController', 'show', array('plugin' => 'OpteiaSkin'), false, 'btn') ?>
    </fieldset>
    </div>
<?php endif ?>
