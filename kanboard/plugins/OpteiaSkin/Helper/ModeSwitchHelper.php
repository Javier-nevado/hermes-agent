...
class ModeSwitchHelper extends BaseHelper
{
    ...
    public function productionMode(){
        ...
        $this->getPlugin()->hook->on('template:layout:css', array('template' => 'plugins/OpteiaSkin'.$this->prdCSSFile));
    }
    ...
    public function developmentMode(){
        ...
        {
            $this->getPlugin()->hook->on('template:layout:css', array('template' => 'plugins/OpteiaSkin'.$value));
        }
    }
