...
namespace Kanboard\Plugin\OpteiaSkin\Model;

class DefaultConfigsModel
{
    private $default_Configs_Schema = array(
        'version'                           => array('default' => '20260623v1'),
        ...
        // Light Colors
        'light_palette' => array(
            // Messages & Actions — Opteia brand purple (#7b68ee family)
            'brand-prim'                    => array('default' => '#7b68ee'),
            'brand-cont'                    => array('default' => '#ffffff'),
            'brand-secd'                    => array('default' => '#ece9ff'),

            'info-prim'                     => array('default' => '#7b68ee'),
            'info-cont'                     => array('default' => '#e8e6ff'),
            ...
            // Greyscales — Opteia light neutrals (navy-black text on clean white)
            'greyscale-1'                   => array('default' => '#0b1219'),
            'greyscale-2'                   => array('default' => 'rgba(11, 18, 25, .14)'),
            'greyscale-3'                   => array('default' => '#e3e8ef'),
            'greyscale-4'                   => array('default' => '#eef2f7'),
            'greyscale-5'                   => array('default' => '#f6f8fb'),
            'greyscale-6'                   => array('default' => '#ffffff'),
        ...
        'dark_palette' => array(
            // Messages & Actions — Opteia brand purple (lighter #9b8aff on dark)
            'brand-prim'                    => array('default' => '#9b8aff'),
            'brand-cont'                    => array('default' => '#0b1219'),
            'brand-secd'                    => array('default' => '#2a2350'),

            'info-prim'                     => array('default' => '#9b8aff'),
            'info-cont'                     => array('default' => '#2a2547'),
            ...
            // Greyscales — Opteia dark navy (#0b1219 page bg, teal-navy surfaces)
            'greyscale-1'                   => array('default' => '#e8ebf0'),
            'greyscale-2'                   => array('default' => 'rgba(255, 255, 255, .15)'),
            'greyscale-3'                   => array('default' => 'rgba(255, 255, 255, .05)'),
            'greyscale-4'                   => array('default' => '#1b2330'),
            'greyscale-5'                   => array('default' => '#141b26'),
            'greyscale-6'                   => array('default' => '#0b1219'),
